// Wrapper de formulário (React Hook Form + Radix), no padrão shadcn/ui.
// A CLI local (preset "radix-nova") não fornece este componente pronto —
// escrito à mão seguindo o mesmo contrato do shadcn/ui clássico
